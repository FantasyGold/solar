...
import (
	...
	"github.com/fantasygold/solar/b58addr"
...
type Deployer struct {
	...
	*contract.ContractsRepository
	...
	// fantasygold base58 sender address used to create a contract.
...
func (d *Deployer) CreateContract(c *contract.CompiledContract, jsonParams []byte, opts *deployer.Options) (err error) {
	// TODO: dry out similar CreateContract code from eth and fantasygold deployers
	name := opts.Name
